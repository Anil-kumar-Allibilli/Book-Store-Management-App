...
public class AppCustomerResponseDTO {
	 ...
	 *
	 * @return The username as a integer.
	 */
	...
	public AppCustomerResponseDTO(int userCode, String password, String username, String userrole, String fullName,
